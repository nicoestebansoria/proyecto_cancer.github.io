...
function HumanBodyMap() {
  ...
  // Función que actualiza el estado al hacer clic en un órgano
  const handleOrganClick = (organ) => {
    setSelectedOrgan(organ);
  };

  // Función para mostrar tooltip con información al pasar el cursor
  ...
  // Oculta el tooltip al salir del área interactiva
  ...
  return (
    ...
    >
      <h1 style={{ fontSize: "26px", fontWeight: "bold" }}>🧍‍♂️ Mapa Interactivo del Cuerpo Humano</h1>
      ...
      >
        ...
        >
          ...
          {/* SVG superpuesto para los puntos interactivos */}
          <svg
            viewBox="0 0 200 250"
            style={{
              position: "absolute",
          ...
          >
            ...
            <circle
              ...
              onMouseOver={(e) => handleMouseOver(e, "❤️ Corazón")}
